...
import { useNavigate } from 'react-router-dom'; // hoặc useRouter nếu dùng Next.js
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex items-center space-x-6">
                            ...
                            <div>
                                ...
                                <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium mt-2 ${selectedUser.user.preStatus ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                                    }`}>
                                    ...
                                    {selectedUser.memberships.map((membership) => (
                                        <div key={membership.id} className="bg-white p-3 rounded border">
                                            <div className="flex justify-between items-start mb-2">
                                                ...
                                                <span className={`px-2 py-1 rounded-full text-xs ${membership.active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                                                    }`}>
